...
from project.fuzzy.settings import SOURCE_FOLDER, COLUMNS
...
class Fuzzy:
	...
	def get_fuzzy_match_generator(self,crm_results, excel_company_name):
		for result in crm_results:
			...
			yield Match(crm_company_id = result[0],crm_company_name = result[1],crm_group_id = result[2], score=fuzz.partial_ratio(excel_company_name, result[1].lower()))
